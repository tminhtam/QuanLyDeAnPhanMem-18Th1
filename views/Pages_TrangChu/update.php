<div class="my-card card shadow-sm mb-3">
	<h5 class="card-header font-roman py-2 font-weight-bolder my-t-shadow bg-xanh"><i class="far fa-stopwatch"></i> TRUYỆN MỚI UPDATE</h5>
...
<script type="text/javascript">
	$('title').text('Tàng Kinh Các | Truyện Mới Cập Nhật');
</script>