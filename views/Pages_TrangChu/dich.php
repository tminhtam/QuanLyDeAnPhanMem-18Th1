<div class="my-card card shadow-sm mb-3">
	<h5 class="card-header font-roman py-2 font-weight-bolder my-t-shadow bg-xanh"><i class="fas fa-language"></i> TRUYỆN DỊCH</h5>
	<div class="card-body py-0 pb-3 my-pad">
		<div class="row">
			<!-- nội dung truyện hot -->
			<?php foreach($data['dich'] as $value){ ?>
...
<script type="text/javascript">
	$('title').text("Tàng Kinh Các | Truyện Dịch");
</script>