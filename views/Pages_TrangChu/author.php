<div class="my-card card shadow-sm mb-3">
	<h5 class="card-header font-roman py-2 font-weight-bolder my-t-shadow bg-xanh"><i class="fab fa-galactic-senate"></i> TÁC GIẢ <span class="text-uppercase"><?php echo $_GET['title']; ?></span> <span class="float-right" style="color: gold;"><?php echo count($data['author']); ?> TRUYỆN</span></h5>
	<div class="card-body py-0 pb-3 my-pad">
		<div class="row">
			<!-- nội dung truyện hot -->
			<?php foreach($data['author'] as $value){ ?>
