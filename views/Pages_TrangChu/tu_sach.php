<div class="my-card card shadow-sm mb-3">
	<h5 class="card-header font-roman py-2 font-weight-bolder my-t-shadow bg-xanh"><i class="fad fa-books"></i> TỦ SÁCH <span class="float-right" style="color: gold;"><?php echo count($data['sach']); ?> TRUYỆN</span></h5>
	<div class="card-body py-0 pb-3 my-pad">
		<div class="row">
			<!-- nội dung truyện hot -->
			<?php foreach($data['sach'] as $value){ ?>
...
<script type="text/javascript">
	$('title').text("Tàng Kinh Các | Tủ Sách");
</script>